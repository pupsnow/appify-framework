...
public class FallbackResourceBundleInternationalizationProviderTest {
    private static final DateFormat DATE_FORMAT = new SimpleDateFormat("yyyy-MM-dd");
    private final InternationalizationProvider internationalizationProvider = new FallbackResourceBundleInternationalizationProvider(Locale.FRENCH,
            Locale.ENGLISH);

    @Test
    public void shouldReturnTranslation() {
        Assert.assertEquals("Message sans paramètres", internationalizationProvider.getMessage("message.without.arguments"));
    }
