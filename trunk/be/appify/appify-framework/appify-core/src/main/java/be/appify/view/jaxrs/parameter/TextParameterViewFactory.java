...
@Singleton
public class TextParameterViewFactory implements TypeSpecificParameterViewFactory {
    ...
    public JaxRsParameterView createParameter(String name, Class<?> parameterType, Parameter parameter, String containingTypeKey,
        ...
        return new JaxRsParameterView(i18nProvider, containingTypeKey, name, AttributeType.TEXT, parameter);
    }
